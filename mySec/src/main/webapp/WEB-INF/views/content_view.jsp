...
$(document).ready(function(){
	...
	$("#id3").click(function(e){
		e.preventDefault();
		location.href = "reply_view.do?bId=${'content_view.bId'}";
	});
});
*/
...
<form action="modify" method="post">
	<fieldset>
		...
		<a href="list?pg=1" target="content">
		목록보기 </a> &nbsp;&nbsp; <a href="delete?bId=${content_view.bId}" 
		target="content">삭제</a> &nbsp;&nbsp;
		<a href="reply_view?bId=${content_view.bId}" target="content">댓글</a>		
	</fieldset>
</form>
